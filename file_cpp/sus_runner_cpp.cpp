...
int main(int argc, char** argv) {
    ...
    if (argc == 5) {
        ...
        tuple<double, vector<string>, unsigned long> seeker_result = file_cpp::seeker_cpp(test_dir,dbg_flag,dbgfull_flag);
        double sorter_time = file_cpp::sorter_cpp(test_dir,get<1>(seeker_result),dbg_flag,dbgfull_flag);
